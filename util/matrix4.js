  ...
  */ key  : "euler_rotate_order",
      ...
      },
      {
        ...
        value: function normalize() {
          var m = this.$matrix;
          var v1 = new Vector4Cls([m.m11, m.m12, m.m13, m.m14]);
          var v2 = new Vector4Cls([m.m21, m.m22, m.m23, m.m24]);
          var v3 = new Vector4Cls([m.m31, m.m32, m.m33, m.m34]);
          var v4 = new Vector4Cls([m.m41, m.m42, m.m43, m.m44]);
          v1.normalize();
          v2.normalize();
          v3.normalize();
      ...
      },
      {
        ...
        value: function alignAxis(axis, vec_) {
          ...
          var loc = new Vector3Cls(),
            scale = new Vector3Cls(),
            rot = new Vector3Cls();
          //we don't use rot
